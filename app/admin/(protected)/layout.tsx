...
import { PersistentAiAssistant } from "@/components/admin/ai/PersistentAiAssistant"
import { UniversalAiSearch } from "@/components/admin/ai/UniversalAiSearch"
...
const NAV_ITEMS = [
  ...
  { href: "/admin/ai-audit", label: "AI Audit Log", icon: ShieldCheck },
    ...
    <div className="flex flex-col h-full bg-sidebar border-r border-sidebar-border">
      ...
      <div className="px-3 py-3 border-t border-sidebar-border">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors w-full"
        >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between gap-4 px-6 py-3.5 border-b border-border bg-card/50 backdrop-blur flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-sm sm:text-base">{currentPage}</h1>
          </div>
