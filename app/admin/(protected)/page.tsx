...
import { Image as ImageIcon, FolderOpen, Users, ClipboardList, Upload, Plus, UserPlus, Inbox } from "lucide-react"
          ...
          <div className="divide-y divide-border">
            {stats?.recentMedia?.length === 0 ? (
              ...
              <div key={m.id} className="flex items-center gap-3 px-5 py-3">
                ...
                <span className={`ml-auto text-xs px-2 py-0.5 rounded-full border ${m.type === 'video' ? 'bg-purple-500/10 text-purple-400 border-purple-500/20' : 'bg-blue-500/10 text-blue-400 border-blue-500/20'}`}>
                  {m.type}
                </span>
              </div>
            ))}
